...
class dreamdex extends Exchange {
    ...
    public function vault_approve(string $symbol, string $currency, ?float $amount, $params = array ()): array {
        /**
    ...
    public function vault_deposit(string $symbol, string $currency, ?float $amount, $params = array ()): array {
         ...
         * @return {array} an unsigned EVM transaction array( to, data, value, chainId, gasLimit, nonce )
         */
        return $this->vault_action('deposit', $symbol, $currency, $amount, $params);
    }
    ...
    public function vault_withdraw(string $symbol, string $currency, ?float $amount, $params = array ()): array {
         ...
         * @return {array} an unsigned EVM transaction array( to, data, value, chainId, gasLimit, nonce )
         */
        return $this->vault_action('withdraw', $symbol, $currency, $amount, $params);
    }

    public function vault_action(string $action, string $symbol, string $currency, ?float $amount, $params = array ()): array {
        $this->authenticate_rest();
        $this->load_markets();
        $market = $this->market($symbol);
