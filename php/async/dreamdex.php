...
class dreamdex extends Exchange {
    ...
    public function fetch_currencies($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            //     {
            //         "currencies" => array(
            //             array( "id" => "0xe8F76...", "code" => "SOMI", "name" => "SOMI", "decimals" => "18" ),
            //             array( "id" => "0xB4AFC...", "code" => "USDC", "name" => "USDC", "decimals" => "6" )
            //         )
            //     }
            //
    ...
    public function fetch_ticker(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            //     {
            //         "symbols" => array(
            //             array( "symbol" => "SOM:USD", "timestamp" => 1765534169841, "high" => "1.30", "low" => "1.20" )
            //         )
            //     }
            //
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            //         "symbol" => "SOM:USD",
            //         "trades" => array(
            //             array( "id" => "t1", "timestamp" => 1765534169841, "symbol" => "SOM:USD", "side" => "buy", "price" => "1.25", "amount" => "100", "cost" => "125" )
            //         )
            //     }
            //
    ...
    public function fetch_balance($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            //     {
            //         "balances" => array(
            //             array( "currency" => "SOM", "amount" => "1000.5" ),
            //             array( "currency" => "USD", "amount" => "500.25" )
            //         )
            //     }
            //
    ...
    public function vault_deposit(string $symbol, string $currency, ?float $amount, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $currency, $amount, $params) {
             ...
             * @return {array} an unsigned EVM transaction array( to, data, value, chainId, gasLimit, nonce )
             */
            return Async\await($this->vault_action('deposit', $symbol, $currency, $amount, $params));
        }) ();
    }
    ...
    public function vault_withdraw(string $symbol, string $currency, ?float $amount, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $currency, $amount, $params) {
             ...
             * @return {array} an unsigned EVM transaction array( to, data, value, chainId, gasLimit, nonce )
             */
            return Async\await($this->vault_action('withdraw', $symbol, $currency, $amount, $params));
        }) ();
    }
