...
use ccxt\async\abstract\dreamdex as Exchange;
...
class dreamdex extends Exchange {
    ...
    public function fetch_currencies($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->publicGetV0Currencies ($params));
            //
            //     {
            //         "currencies" => array(
    ...
    public function fetch_markets($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->publicGetV0Markets ($params));
            //
            //     {
            //         "markets" => array(
            //             {
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->publicGetV0Orderbooks ($this->extend($request, $params)));
            //
            //     {
            //         "orderbooks" => array(
            //             {
    ...
    public function fetch_ticker(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = Async\await($this->publicGetV0MarketsSymbolTickers ($this->extend($request, $params)));
            //
            //     {
            //         "symbols" => array(
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            $response = Async\await($this->publicGetV0Tickers ($this->extend($request, $params)));
            //
            //     {
            //         "symbols" => array(
            //             array( "symbol" => "SOMI:USDso", "timestamp" => 1765534169841, "open" => "1.20", "high" => "1.30", "low" => "1.18", "close" => "1.25", "volume" => "1000" )
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->publicGetV0MarketsSymbolTrades ($this->extend($request, $params)));
            //
            //     {
            //         "symbol" => "SOMI:USDso",
            //         "trades" => array(
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetV0MarketsSymbolTradesMine ($this->extend($request, $params)));
            //
            //     {
            //         "symbol" => "SOMI:USDso",
            //         "trades" => array(
    ...
    public function fetch_ohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $timeframe, $since, $limit, $params) {
            ...
            $response = Async\await($this->publicGetV0MarketsSymbolCandles ($this->extend($request, $params)));
            //
            //     {
            //         "symbol" => "SOMI:USDso",
            //         "interval" => "1m",
    ...
    public function fetch_balance($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->privateGetV0MarketsSymbolVaultBalance ($this->extend($request, $params)));
            //
            //     {
            //         "balances" => array(
    ...
    public function vault_approve(string $symbol, string $currency, ?float $amount, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $currency, $amount, $params) {
            /**
             ...
             */
            return Async\await($this->vault_action('approve', $symbol, $currency, $amount, $params));
        }) ();
    }

    public function vault_deposit(string $symbol, string $currency, ?float $amount, $params = array ()): PromiseInterface {
        /**
    ...
    public function vault_withdraw(string $symbol, string $currency, ?float $amount, $params = array ()): PromiseInterface {
        /**
    ...
    public function vault_action(string $action, string $symbol, string $currency, ?float $amount, $params = array ()): PromiseInterface {
        return Async\async(function () use ($action, $symbol, $currency, $amount, $params) {
            Async\await($this->authenticate_rest());
            Async\await($this->load_markets());
            $market = $this->market($symbol);
            ...
            $response = null;
            if ($action === 'approve') {
                $response = Async\await($this->privatePostV0MarketsSymbolVaultApprove ($this->extend($request, $params)));
            } elseif ($action === 'deposit') {
                $response = Async\await($this->privatePostV0MarketsSymbolVaultDeposit ($this->extend($request, $params)));
            } elseif ($action === 'withdraw') {
                $response = Async\await($this->privatePostV0MarketsSymbolVaultWithdraw ($this->extend($request, $params)));
            }
            //
            //     {
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            if ($triggerPrice !== null) {
                ...
                $stopResponse = Async\await($this->privatePostV0MarketsSymbolStopOrders ($this->extend($stopRequest, $params)));
                //
                //     {
            ...
            $response = Async\await($this->privatePostV0MarketsSymbolOrders ($this->extend($request, $params)));
            //
            //     {
            //         "chainId" => "50312",
            //         "data" => "0x80702f83...",
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->privateGetV0MarketsSymbolOrdersId ($this->extend($request, $params)));
            //
            //     {
    ...
    public function fetch_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            if ($symbol === null) {
                ...
                $allResponse = Async\await($this->privateGetV0Orders ($params));
            ...
            if ($stop) {
                ...
                $stopResponse = Async\await($this->privateGetV0MarketsSymbolStopOrders ($this->extend($request, $params)));
                $stopOrders = $this->safe_list($stopResponse, 'stopOrders', array());
                return $this->parse_orders($stopOrders, $market, $since, $limit);
            }
            $response = Async\await($this->privateGetV0MarketsSymbolOrders ($this->extend($request, $params)));
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            if ($stop) {
                $params = $this->omit($params, array( 'stop', 'trigger' ));
                $stopResponse = Async\await($this->privateDeleteV0MarketsSymbolStopOrdersId ($this->extend($request, $params)));
            ...
            $response = Async\await($this->privateDeleteV0MarketsSymbolOrdersId ($this->extend($request, $params)));
            return $this->parse_order($response, $market);
        }) ();
    }
    ...
    public function edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $type, $side, $amount, $price, $params) {
            ...
            $response = Async\await($this->privatePatchV0MarketsSymbolOrdersIdReduce ($this->extend($request, $params)));
            //
            //     {
    ...
    public function authenticate_rest($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $nonceResponse = Async\await($this->publicGetV0AuthNonce ($params));
            ...
            $loginResponse = Async\await($this->publicPostV0AuthLogin ($loginRequest));
            //
