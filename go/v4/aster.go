...
func  (this *AsterCore) LoadMarketsAndSignIn() <- chan interface{} {
        ...
        retRes42248 := (<-promiseAll([]interface{}{this.LoadMarkets(), this.SignIn()}))
