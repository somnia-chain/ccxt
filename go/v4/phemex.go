 ...
 */
func  (this *PhemexCore) FetchPositionHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            //
            var data interface{} = this.SafeList(response, "data", []interface{}{})
            var positions interface{} = this.ParsePositions(data, []interface{}{symbol})
...
func  (this *PhemexCore) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var contracts interface{} = this.SafeStringN(position, []interface{}{"size", "sizeRq", "closedSizeRq"})
    ...
    var entryPriceString interface{} = this.SafeStringN(position, []interface{}{"avgEntryPrice", "avgEntryPriceRp", "openPrice"})
    var rawSide interface{} = this.SafeString(position, "side")
    var side interface{} = nil
    if IsTrue(!IsEqual(rawSide, nil)) {
        var isLong interface{} =         (IsTrue(IsEqual(rawSide, "Buy")) || IsTrue(IsEqual(rawSide, "1")))
    ...
    var timestamp interface{} = this.SafeInteger(position, "openedTimeNs")
    var lastUpdateTimestamp interface{} = this.SafeInteger(position, "updatedTimeNs", this.SafeIntegerProduct(position, "transactTimeNs", 0.000001))
