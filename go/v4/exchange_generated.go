...
func  (this *Exchange) FindMessageHashes(client interface{}, element interface{}) interface{}  {
    var result interface{} = []interface{}{}
...
func  (this *Exchange) SetMarketsFromExchange(sourceExchange interface{}) interface{}  {
...
func  (this *Exchange) SafeNetwork(network interface{}) interface{}  {
...
func  (this *Exchange) FetchTransactionFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(GetValue(this.Has, "fetchTransactionFees")) {
                ...
                retRes611615 :=  (<-this.FetchTransactionFees([]interface{}{code}, params))
...
func  (this *Exchange) CancelOrdersWithClientOrderIds(clientOrderIds interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes700615 :=  (<-this.CancelOrders([]interface{}{}, symbol, extendedParams))
...
func  (this *Exchange) LoadMarketsAndSignIn() <- chan interface{} {
        ...
        retRes89498 := (<-promiseAll([]interface{}{this.LoadMarkets(), <-this.callInternal("signIn")}))
...
func  (this *Exchange) CleanUnsubscription(client interface{}, subHash interface{}, unsubHash interface{}, optionalArgs ...interface{})  {
    ...
    if IsTrue(IsEqual(topic, "ohlcv")) {
        ...
        if IsTrue(IsTrue(IsEqual(topic, "myTrades")) && IsTrue((!IsEqual(this.MyTrades, nil)))) {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(clients)); i++ {
                ...
                var futures interface{} = client.Futures
