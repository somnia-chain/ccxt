...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestFeatures(exchange interface{}, skippedProperties interface{}) <- chan interface{} {
    ...
    func TestFeaturesInner(exchange interface{}, skippedProperties interface{}, featureObj interface{})  {
