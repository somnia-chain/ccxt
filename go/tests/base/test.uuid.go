...
func TestUuid()  {
    ...
    assert(ccxt.IsEqual(ccxt.ToString(id16a), id16a), ccxt.Add("uuid16() must return a string, returned id16a: ", id16a))
    assert(ccxt.IsEqual(ccxt.ToString(id16b), id16b), ccxt.Add("uuid16() must return a string, returned id16b: ", id16b))
    ...
    assert(ccxt.IsEqual(ccxt.ToString(id22a), id22a), ccxt.Add("uuid22() must return a string, returned id22a: ", id22a))
    assert(ccxt.IsEqual(ccxt.ToString(id22b), id22b), ccxt.Add("uuid22() must return a string, returned id22b: ", id22b))
    assert(ccxt.IsEqual(ccxt.GetLength(id22a), 22), ccxt.Add("uuid22() must return a 22-character string, returned id22a: ", id22a))
    assert(ccxt.IsEqual(ccxt.GetLength(id22b), 22), ccxt.Add("uuid22() must return a 22-character string, returned id22b: ", id22b))
}