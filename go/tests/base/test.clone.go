...
func TestClone()  {
    ...
    var compareTo interface{} = map[string]interface{} {
        "a": 2,
        "b": []interface{}{3, 4},
        "c": []interface{}{map[string]interface{} {
    "test1": 2,
    ...
    var simpleOrig interface{} = map[string]interface{} {
        "x": 1,
        "y": "hello",
        "z": nil,
    }
    ...
    var nestedOrig interface{} = map[string]interface{} {
        "top": "original",
    ...
    var withUndef interface{} = map[string]interface{} {
        "present": "yes",
        "absent": nil,
    }
    ...
    var masterOrig interface{} = map[string]interface{} {
        "a": 1,
        "b": 2,
        "c": 3,
    }
