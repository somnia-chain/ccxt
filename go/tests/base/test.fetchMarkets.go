...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestFetchMarkets(exchange interface{}, skippedProperties interface{}) <- chan interface{} {
    ...
    func DetectMarketConflicts(exchange interface{}, marketValues interface{}) interface{}  {
