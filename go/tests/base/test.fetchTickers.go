...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestFetchTickers(exchange interface{}, skippedProperties interface{}, symbol interface{}) <- chan interface{} {
    ...
    func TestFetchTickersHelper(exchange interface{}, skippedProperties interface{}, argSymbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
                ch := make(chan interface{})
                go func() interface{} {
                    defer close(ch)
                    defer ReturnPanicError(ch)
    ...
    func TestFetchTickersAmounts(exchange interface{}, skippedProperties interface{}, tickers interface{})  {
