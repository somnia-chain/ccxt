...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestWatchTickers(exchange interface{}, skippedProperties interface{}, symbol interface{}) <- chan interface{} {
    ...
    func TestWatchTickersHelper(exchange interface{}, skippedProperties interface{}, argSymbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
                ch := make(chan interface{})
                go func() interface{} {
                    defer close(ch)
                    defer ReturnPanicError(ch)
