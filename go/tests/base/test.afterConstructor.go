...
func HelperTestSandboxState(exchange interface{}, optionalArgs ...interface{})  {
...
func HelperTestProperties()  {
    exchange := ccxt.NewExchange().(*ccxt.Exchange); exchange.DerivedExchange = exchange; exchange.InitParent(map[string]interface{} {}, map[string]any{}, exchange)
    //
    // userAgents
    //
    ...
    var defaultNetworkCodeReplacements interface{} = map[string]interface{} {
    ...
    var requiredCredentials interface{} = map[string]interface{} {
        "apiKey": true,
        "secret": true,
        "uid": false,
        "accountId": false,
