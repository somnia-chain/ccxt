...
func PreciseEqualStr(exchange interface{}, result interface{}, key interface{}, expected interface{}) interface{}  {
...
func TestSafeTicker()  {
    ...
    // CASE 1 - by open
    var ticker1 interface{} = map[string]interface{} {
        "open": 5,
        "change": 1,
    }
    ...
    // CASE 2 - by open
    var ticker2 interface{} = map[string]interface{} {
        "open": 5,
        "percentage": 20,
    }
    ...
    // CASE 3 - by close
    var ticker3 interface{} = map[string]interface{} {
        "close": 6,
        "change": 1,
    }
    ...
    // CASE 4 - by close
    var ticker4 interface{} = map[string]interface{} {
        "close": 6,
        "percentage": 20,
    }
    ...
    // CASE 5 - by average
    var ticker5 interface{} = map[string]interface{} {
        "average": 5.5,
        "percentage": 20,
    }
    ...
    // CASE 6
    var ticker6 interface{} = map[string]interface{} {
        "average": 5.5,
        "change": 1,
    }
    ...
    var ticker7 interface{} = map[string]interface{} {
        "open": 5,
        "close": 6,
    }
    ...
    // CASE 8 - full ticker
    var ticker8 interface{} = map[string]interface{} {
        "open": 5,
        "close": 6,
        "last": 6,
        "high": 6.5,
