...
func TestIndexBy()  {
    ...
    var expected1 interface{} = map[string]interface{} {
    ...
    var expected2 interface{} = map[string]interface{} {
        "a": map[string]interface{} {
            "id": "a",
            "val": 1,
        },
    ...
    var expected4 interface{} = map[string]interface{} {}
    ...
    var expected5 interface{} = map[string]interface{} {
        "a": map[string]interface{} {
            "id": "a",
            "val": 3,
        },
    ...
    var expected6 interface{} = map[string]interface{} {
    ...
    var expected7 interface{} = map[string]interface{} {
        "a": []interface{}{"a", 1},
        "b": []interface{}{"b", 2},
        "c": []interface{}{"c", 3},
    }
    ...
    var expected8 interface{} = map[string]interface{} {
