...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestFetchCurrencies(exchange interface{}, skippedProperties interface{}) <- chan interface{} {
    ...
    func DetectCurrencyConflicts(exchange interface{}, currencyValues interface{}) interface{}  {
