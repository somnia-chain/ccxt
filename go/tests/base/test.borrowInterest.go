...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestBorrowInterest(exchange interface{}, skippedProperties interface{}, method interface{}, entry interface{}, requestedCode interface{}, requestedSymbol interface{})  {
