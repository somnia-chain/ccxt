...
func TestExtend()  {
    ...
    var obj3 interface{} = map[string]interface{} {
        "a": 3,
        "b": []interface{}{5, 6},
        "c": []interface{}{map[string]interface{} {
    "test1": 3,
    ...
    var patch1 interface{} = map[string]interface{} {
        "x": 1,
        "p1": true,
    }
    var patch2 interface{} = map[string]interface{} {
        "x": 2,
        "p2": true,
    }
    var patch3 interface{} = map[string]interface{} {
        "x": 3,
        "p3": true,
    }
    ...
    var withValues interface{} = map[string]interface{} {
        "keep1": "A",
        "keep2": "B",
    }
    var withUndefs interface{} = map[string]interface{} {
        "keep1": nil,
        "keep2": nil,
        "newKey": "C",
    }
