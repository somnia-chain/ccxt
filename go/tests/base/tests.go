...
func  (this *testMainClass) Init(exchangeId interface{}, symbolArgv interface{}, methodArgv interface{}) <- chan interface{} {
            ...
            go func() interface{} {
                    ...
                    
                {
                    ...
                    retRes9312 := (<-this.InitInner(exchangeId, symbolArgv, methodArgv))
...
func  (this *testMainClass) InitInner(exchangeId interface{}, symbolArgv interface{}, methodArgv interface{}) <- chan interface{} {
            ...
            if IsTrue(IsTrue(this.RequestTests) && IsTrue(this.ResponseTests)) {
                ...
                retRes10412 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
                PanicOnError(retRes10412)
        
                retRes10512 := (<-this.RunStaticResponseTests(exchangeId, symbolArgv))
            ...
            if IsTrue(this.ResponseTests) {
                ...
                retRes10912 := (<-this.RunStaticResponseTests(exchangeId, symbolArgv))
                PanicOnError(retRes10912)
            ...
            if IsTrue(this.RequestTests) {
                ...
                retRes11312 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
                PanicOnError(retRes11312) // symbol here is the testname
            ...
            if IsTrue(this.IdTests) {
                ...
                retRes11712 := (<-this.RunBrokerIdTests())
                PanicOnError(retRes11712)
            ...
            var exchange interface{} = InitExchange(exchangeId, exchangeArgs, this.WsTests)
            if IsTrue(exchange.GetAlias()) {
                Dump(this.AddPadding("[INFO] skipping alias", 25))
                ExitScript(0)
            }
        
            retRes1338 := (<-this.ImportFiles(exchange))
            PanicOnError(retRes1338)
            ...
            retRes1378 := (<-this.StartTest(exchange, symbolArgv))
            PanicOnError(retRes1378)
...
func  (this *testMainClass) ImportFiles(exchange interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *testMainClass) LoadCredentialsFromEnv(exchange interface{})  {
...
func  (this *testMainClass) ExpandSettings(exchange interface{})  {
    var exchangeId interface{} = exchange.GetId()
...
func  (this *testMainClass) TestMethod(methodName interface{}, exchange interface{}, args interface{}, isPublic interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            if IsTrue(isLoadMarkets) {
                ...
                retRes29112 := (<-exchange.LoadMarkets(true))
                PanicOnError(retRes29112)
            }
            ...
            if IsTrue(IsSync()) {
                ...
                retRes30712 := (<-CallMethod(this.TestFiles, methodName, exchange, skippedPropertiesForMethod, args))
                PanicOnError(retRes30712)
            }
            if IsTrue(this.Info) {
...
func  (this *testMainClass) GetSkips(exchange interface{}, methodName interface{}) interface{}  {
...
func  (this *testMainClass) TestSafe(methodName interface{}, exchange interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            for i := 0; IsLessThan(i, maxRetries); i++ {
                
                    {
                         func(this *testMainClass) (ret_ interface{}) {
                            ...
                            var lastUrlMsg interface{} = Ternary(IsTrue(this.WsTests), "", Add(Add(" (Last url: ", exchange.GetLast_request_url()), " )"))
                            if IsTrue(isOperationFailed) {
                                ...
                                if IsTrue(IsEqual(i, Subtract(maxRetries, 1))) {
                                    ...
                                    retRes42924 := (<-exchange.Sleep(Multiply((Add(i, 1)), 1000)))
                                    PanicOnError(retRes42924)
                                }
                            } else {
                            ...
                            retRes38216 := (<-this.TestMethod(methodName, exchange, args, isPublic))
                            PanicOnError(retRes38216)
...
func  (this *testMainClass) RunPublicTests(exchange interface{}, symbols interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                    var primarySymbol interface{} = GetValue(symbols, 0)
            var tests interface{} = map[string]interface{} {
                "features": []interface{}{},
                "fetchCurrencies": []interface{}{},
                "fetchTicker": []interface{}{primarySymbol},
                "fetchTickers": []interface{}{primarySymbol},
                "fetchLastPrices": []interface{}{primarySymbol},
                "fetchOHLCV": []interface{}{primarySymbol},
                "fetchTrades": []interface{}{primarySymbol},
                "fetchOrderBook": []interface{}{primarySymbol},
            ...
            if IsTrue(this.WsTests) {
                tests = map[string]interface{} {
                    "watchOHLCV": []interface{}{primarySymbol},
                    "watchOHLCVForSymbols": []interface{}{primarySymbol},
                    "watchTicker": []interface{}{primarySymbol},
                    "watchTickers": []interface{}{primarySymbol},
                    "watchBidsAsks": []interface{}{primarySymbol},
                    "watchOrderBook": []interface{}{primarySymbol},
                    "watchOrderBookForSymbols": []interface{}{symbols},
                    "watchTrades": []interface{}{primarySymbol},
                    "watchTradesForSymbols": []interface{}{symbols},
                }
            }
            var market interface{} = exchange.Market(primarySymbol)
            var isSpot interface{} = GetValue(market, "spot")
            if !IsTrue(this.WsTests) {
                if IsTrue(isSpot) {
                    AddElementToObject(tests, "fetchCurrencies", []interface{}{})
                } else {
                    AddElementToObject(tests, "fetchFundingRates", []interface{}{primarySymbol})
                    AddElementToObject(tests, "fetchFundingRate", []interface{}{primarySymbol})
                    AddElementToObject(tests, "fetchFundingRateHistory", []interface{}{primarySymbol})
                    AddElementToObject(tests, "fetchIndexOHLCV", []interface{}{primarySymbol})
                    AddElementToObject(tests, "fetchMarkOHLCV", []interface{}{primarySymbol})
                    AddElementToObject(tests, "fetchPremiumIndexOHLCV", []interface{}{primarySymbol})
                }
            }
            this.PublicTests = tests
        
            retRes5148 := (<-this.RunTests(exchange, tests, true))
...
func  (this *testMainClass) RunTests(exchange interface{}, tests interface{}, isPublicTest interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *testMainClass) LoadExchange(exchange interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *testMainClass) GetTestSymbol(exchange interface{}, isSpot interface{}, symbols interface{}) interface{}  {
...
func  (this *testMainClass) GetExchangeCode(exchange interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *testMainClass) GetMarketsFromExchange(exchange interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *testMainClass) GetValidSymbol(exchange interface{}, optionalArgs ...interface{}) interface{}  {
    spot := GetArg(optionalArgs, 0, true)
    _ = spot
    ...
    var swapSymbols interface{} = []interface{}{"BTC/USDT:USDT", "BTC/USD:USDT", "BTC/USDC:USDC", "BTC/USD:USDC", "BTC/USD:USD", "ETH/USDT:USDT", "ETH/USD:USDT", "ETH/USDC:USDC", "ETH/USD:USDC", "ETH/USD:USD", "BTC/USD:BTC", "ETH/USD:ETH"}
...
func  (this *testMainClass) TestExchange(exchange interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            _ = providedSymbol
            var spotSymbols interface{} = nil
            var swapSymbols interface{} = nil
            if IsTrue(!IsEqual(providedSymbol, nil)) {
                var market interface{} = exchange.Market(providedSymbol)
                if IsTrue(GetValue(market, "spot")) {
                    spotSymbols = []interface{}{providedSymbol}
                } else {
                    swapSymbols = []interface{}{providedSymbol}
                }
            } else {
                if IsTrue(GetValue(exchange.GetHas(), "spot")) {
                    var primarySymbol interface{} = this.GetValidSymbol(exchange, true)
                    var secondarySymbol interface{} = Replace(primarySymbol, "BTC", "ETH") // this should work any exchange
                    spotSymbols = []interface{}{primarySymbol, secondarySymbol}
                }
                if IsTrue(GetValue(exchange.GetHas(), "swap")) {
                    var primarySymbol interface{} = this.GetValidSymbol(exchange, false)
                    var secondarySymbol interface{} = Replace(primarySymbol, "BTC", "ETH") // this should work any exchange
                    swapSymbols = []interface{}{primarySymbol, secondarySymbol}
                }
            }
            ...
            if !IsTrue(this.PrivateTestOnly) {
                ...
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbols, nil))) {
                    ...
                    retRes75116 := (<-this.RunPublicTests(exchange, spotSymbols))
                ...
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbols, nil))) {
                    ...
                    retRes75816 := (<-this.RunPublicTests(exchange, swapSymbols))
                    PanicOnError(retRes75816)
                }
            }
            if IsTrue(IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly)) {
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbols, nil))) {
                    ...
                    retRes76416 := (<-this.RunPrivateTests(exchange, spotSymbols))
                    PanicOnError(retRes76416)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbols, nil))) {
                    AddElementToObject(exchange.GetOptions(), "defaultType", "swap")
        
                    retRes76816 := (<-this.RunPrivateTests(exchange, swapSymbols))
                    PanicOnError(retRes76816)
                }
            }
...
func  (this *testMainClass) RunPrivateTests(exchange interface{}, symbol interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            retRes8628 := (<-this.RunTests(exchange, tests, false))
...
func  (this *testMainClass) TestProxies(exchange interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            for j := 0; IsLessThan(j, maxRetries); j++ {
                
                    {
                         func(this *testMainClass) (ret_ interface{}) {
                            ...
                            retRes88216 := (<-exchange.Sleep(Multiply(j, 1000)))
                            PanicOnError(retRes88216)
                                        return nil
                                    }(this)
                                }
                            }()
                            ...
                            retRes87816 := (<-this.TestMethod(proxyTestName, exchange, []interface{}{}, true))
                            PanicOnError(retRes87816)
...
func  (this *testMainClass) CheckConstructor(exchange interface{})  {
...
func  (this *testMainClass) TestReturnResponseHeaders(exchange interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *testMainClass) StartTest(exchange interface{}, symbolArgv interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            if IsTrue(IsTrue(this.Sandbox) || IsTrue(GetExchangeProp(exchange, "sandbox"))) {
            ...
            
                {
                     func(this *testMainClass) (ret_ interface{}) {
                        ...
                        retRes95316 := (<-Close(exchange))
                        PanicOnError(retRes95316)
                    }
                    panic(e)
                    ...
                    if !IsTrue(result) {
                        if !IsTrue(IsSync()) {
                            ...
                            retRes93920 := (<-Close(exchange))
                            PanicOnError(retRes93920)
                        }
                    ...
                    retRes94712 := (<-this.TestExchange(exchange, symbolArgv))
                    PanicOnError(retRes94712)
                    if !IsTrue(IsSync()) {
            
                        retRes94916 := (<-Close(exchange))
                        PanicOnError(retRes94916)
                    }
            		    return nil
            	    }(this)
...
func  (this *testMainClass) AssertNewAndStoredOutputInner(exchange interface{}, skipKeys interface{}, newOutput interface{}, storedOutput interface{}, optionalArgs ...interface{}) interface{}  {
...
func  (this *testMainClass) AssertNewAndStoredOutput(exchange interface{}, skipKeys interface{}, newOutput interface{}, storedOutput interface{}, optionalArgs ...interface{}) interface{}  {
    strictTypeCheck := GetArg(optionalArgs, 0, true)
    _ = strictTypeCheck
    assertingKey := GetArg(optionalArgs, 1, nil)
    _ = assertingKey
...
func  (this *testMainClass) AssertStaticRequestOutput(exchange interface{}, typeVar interface{}, skipKeys interface{}, storedUrl interface{}, requestUrl interface{}, storedOutput interface{}, newOutput interface{}) interface{}  {
...
func  (this *testMainClass) AssertStaticResponseOutput(exchange interface{}, skipKeys interface{}, computedResult interface{}, storedResult interface{})  {
...
func  (this *testMainClass) TestRequestStatically(exchange interface{}, method interface{}, data interface{}, typeVar interface{}, skipKeys interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            if IsTrue(this.Info) {
            ...
            
                {
                    ...
                    requestUrl = exchange.GetLast_request_url()
                        ...
                        retRes126716 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
...
func  (this *testMainClass) TestResponseStatically(exchange interface{}, method interface{}, skipKeys interface{}, data interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                    var expectedResult interface{} = exchange.SafeValue(data, "parsedResponse")
            var mockedExchange interface{} = SetFetchResponse(exchange, GetValue(data, "httpResponse"))
            if IsTrue(this.Info) {
...
func  (this *testMainClass) InitOfflineExchange(exchangeName interface{}) interface{}  {
    ...
    var wasmExecPath interface{} = nil
    ...
    var basePath interface{} = Add(GetRootDir(), "ts/src/test/static/binaries/")
    ...
    var options interface{} = map[string]interface{} {
        "markets": markets,
    ...
    var exchange interface{} = InitExchange(exchangeName, options)
...
func  (this *testMainClass) TestExchangeRequestStatically(exchangeName interface{}, exchangeData interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = testName
            var exchange interface{} = this.InitOfflineExchange(exchangeName)
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes146116 := (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
                    PanicOnError(retRes146116)
                    // reset options
...
func  (this *testMainClass) TestExchangeResponseStatically(exchangeName interface{}, exchangeData interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes153216 := (<-this.TestResponseStatically(exchange, method, skipKeys, result))
                    PanicOnError(retRes153216)
                    // reset options
...
func  (this *testMainClass) GetNumberOfTestsFromExchange(exchange interface{}, exchangeData interface{}, optionalArgs ...interface{}) interface{}  {
    testName := GetArg(optionalArgs, 0, nil)
    _ = testName
...
func  (this *testMainClass) CheckIfExchangeIsDisabled(exchangeName interface{}, exchangeData interface{}) interface{}  {
    var exchange interface{} = InitExchange("Exchange", map[string]interface{} {})
...
func  (this *testMainClass) RunStaticRequestTests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes15868 := (<-this.RunStaticTests("request", targetExchange, testName))
...
func  (this *testMainClass) RunStaticTests(typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var exchange interface{} = InitExchange("Exchange", map[string]interface{} {}) // tmp to do the calculations until we have the ast-transpiler transpiling this code
            var promises interface{} = []interface{}{}
            var sum interface{} = 0
            if IsTrue(targetExchange) {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(exchanges)); i++ {
            ...
            
                {
                    ...
                    retRes162212 := (<-promiseAll(promises))
...
func  (this *testMainClass) RunStaticResponseTests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes16468 := (<-this.RunStaticTests("response", exchangeName, test))
...
func  (this *testMainClass) RunBrokerIdTests() <- chan interface{} {
        ...
        retRes16858 := (<-promiseAll(promises))
...
func  (this *testMainClass) TestBinance() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("binance")
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes169912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest interface{} = nil
            ...
            retRes170912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest interface{} = nil
            ...
            retRes171512 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
        ...
        var swapAlgoOrderRequest interface{} = nil
            ...
            retRes172912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 0.002, 102000, map[string]interface{} {
                "triggerPrice": 101000,
            }))
        ...
        var createOrdersRequest interface{} = nil
            ...
            retRes175612 := (<-exchange.CreateOrders(orders))
...
func  (this *testMainClass) TestOkx() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("okx")
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes177712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest interface{} = nil
            ...
            retRes178812 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCryptocom() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("cryptocom")
        var id interface{} = "CCXT"
        
        retRes18058 := (<-exchange.LoadMarkets())
        ...
        var request interface{} = nil
            ...
            retRes180812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBybit() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("bybit")
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "brokerId"), id), "id not in options")
            ...
            retRes182612 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestKucoin() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("kucoin")
        ...
        Assert(IsEqual(futureKey, "1b327198-f30c-4f14-a0ac-918871282f15"), Add(Add("kucoin - key: ", futureKey), " not in options."))
            ...
            retRes185112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoin - id: ", id), " not in headers for spot orders."))
            ...
            retRes185912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000, map[string]interface{} {
                "uta": true,
            }))
        ...
        id = "ccxtfutures"
            ...
            retRes186612 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoin - id: ", id), " not in headers for swap orders."))
            ...
            retRes187212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]interface{} {
                "uta": true,
            }))
            PanicOnError(retRes187212)
        		    return nil
        	    }(this)
...
func  (this *testMainClass) TestKucoinfutures() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("kucoinfutures")
        var reqHeaders interface{} = nil
        ...
        Assert(IsEqual(futureKey, "1b327198-f30c-4f14-a0ac-918871282f15"), Add(Add("kucoinfutures - key: ", futureKey), " not in options."))
            ...
            retRes189312 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes189312)
        		    return nil
        	    }(this)
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoinfutures - id: ", id), " not in headers."))
            ...
            retRes190012 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBitget() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("bitget")
        var reqHeaders interface{} = nil
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "broker"), id), Add(Add("bitget - id: ", id), " not in options"))
            ...
            retRes191712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestMexc() <- chan interface{} {
        ...
        PanicOnError(retRes19338)
            ...
            retRes193512 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestHtx() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("htx")
        // spot test
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes195212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest interface{} = nil
            ...
            retRes196212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest interface{} = nil
            ...
            retRes196812 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoo() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("woo")
        // spot test
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes198812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var stopOrderRequest interface{} = nil
            ...
            retRes199812 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]interface{} {
                "stopPrice": 30000,
            }))
...
func  (this *testMainClass) TestBitmart() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("bitmart")
        var reqHeaders interface{} = nil
        ...
        retRes20158 := (<-exchange.LoadMarkets())
        PanicOnError(retRes20158)
            ...
            retRes201712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCoinex() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("coinex")
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes203412 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes203412)
        		    return nil
        	    }(this)
...
func  (this *testMainClass) TestBingx() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("bingx")
        var reqHeaders interface{} = nil
        var id interface{} = "CCXT"
        Assert(IsEqual(GetValue(exchange.GetOptions(), "broker"), id), Add(Add("bingx - id: ", id), " not in options"))
            ...
            retRes205312 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestPhemex() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("phemex")
        ...
        var request interface{} = nil
            ...
            retRes207012 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBlofin() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("blofin")
        ...
        var request interface{} = nil
            ...
            retRes208812 := (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
...
func  (this *testMainClass) TestCoinbaseinternational() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("coinbaseinternational")
        ...
        var request interface{} = nil
            ...
            retRes212512 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCoinbaseAdvanced() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("coinbase")
        var id interface{} = "ccxt"
        Assert(IsEqual(GetValue(exchange.GetOptions(), "brokerId"), id), "id not in options")
        var request interface{} = nil
            ...
            retRes214312 := (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoofiPro() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("woofipro")
        exchange.SetSecret("secretsecretsecretsecretsecretsecretsecrets")
        var id interface{} = "CCXT"
        
        retRes21598 := (<-exchange.LoadMarkets())
        ...
        var request interface{} = nil
            ...
            retRes216212 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestOxfun() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("oxfun")
        exchange.SetSecret("secretsecretsecretsecretsecretsecretsecrets")
        var id interface{} = 1000
        
        retRes21788 := (<-exchange.LoadMarkets())
        ...
        var request interface{} = nil
            ...
            retRes218112 := (<-exchange.CreateOrder("BTC/USD:OX", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestXT() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("xt")
        var id interface{} = "CCXT"
        var spotOrderRequest interface{} = nil
            ...
            retRes219712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest interface{} = nil
            ...
            retRes220512 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestParadex() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("paradex")
        ...
        retRes22278 := (<-exchange.LoadMarkets())
        PanicOnError(retRes22278)
            ...
            retRes222912 := (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes222912)
        		    return nil
        	    }(this)
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes223512 := (<-Close(exchange))
            PanicOnError(retRes223512)
        }
...
func  (this *testMainClass) TestHashkey() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("hashkey")
        var reqHeaders interface{} = nil
        var id interface{} = "10000700011"
            ...
            retRes224512 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes225212 := (<-Close(exchange))
            PanicOnError(retRes225212)
        }
...
func  (this *testMainClass) TestCryptomus() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("cryptomus")
        var request interface{} = nil
            ...
            retRes226112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "sell", 1, 20000))
            PanicOnError(retRes226112)
        		    return nil
        	    }(this)
...
func  (this *testMainClass) TestDerive() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("derive")
        ...
        var request interface{} = nil
            ...
            retRes228612 := (<-exchange.CreateOrder("LBTC/USDC", "limit", "sell", 0.01, 3000, params))
...
func  (this *testMainClass) TestModeTrade() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("modetrade")
        exchange.SetSecret("secretsecretsecretsecretsecretsecretsecrets")
        var id interface{} = "CCXTMODE"
        
        retRes23018 := (<-exchange.LoadMarkets())
        ...
        var request interface{} = nil
            ...
            retRes230412 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes230412)
        		    return nil
        	    }(this)
...
func  (this *testMainClass) TestBackpack() <- chan interface{} {
            ...
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("backpack")
        ...
        var id interface{} = "1400"
            ...
            retRes232312 := (<-exchange.CreateOrder("ETH/USDC", "limit", "buy", 1, 5000))
...
func  (this *testMainClass) TestToobit() <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("toobit")
        var reqHeaders interface{} = nil
        var id interface{} = "177321641268789"
            ...
            retRes234012 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWeex() <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
                var exchange interface{} = this.InitOfflineExchange("weex")
        var id interface{} = "b-WEEX111125"
        ...
        var request interface{} = nil
            ...
            retRes235812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes235812)
        		    return nil
        	    }(this)
            
                }
        var clientOrderId interface{} = GetValue(request, "newClientOrderId")
        Assert(StartsWith(clientOrderId, id), Add(Add(Add("weex - newClientOrderId: ", clientOrderId), " for spot order does not start with id: "), id))
            ...
            retRes236512 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        Assert(StartsWith(clientOrderId, id), Add(Add(Add("weex - newClientOrderId: ", clientOrderId), " for swap order does not start with id: "), id))
                return nil
            }()
            return ch
        }
